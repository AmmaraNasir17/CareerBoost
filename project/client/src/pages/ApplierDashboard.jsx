      ...
      <main className="md:ml-64 mt-16 px-4 sm:px-6 lg:px-8 py-6 md:py-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-6 md:mb-8">
            ...
            <p className="text-sm md:text-base text-gray-600">Here's an overview of your job search progress</p>
          </div>

          {/* Stats Grid */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-6 md:mb-8">
            <StatsCard icon={BriefcaseIcon} label="Applications Sent" value="24" color="blue" trend={{ positive: true, value: 12 }} />
            <StatsCard icon={CheckCircleIcon} label="Shortlisted" value="8" color="green" trend={{ positive: true, value: 8 }} />
            <StatsCard icon={XCircleIcon} label="Rejections" value="3" color="red" trend={{ positive: false, value: 2 }} />
          </div>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <div className="px-4 md:px-6 py-4 md:py-6 border-b border-gray-200">
                  <h2 className="text-base md:text-lg font-bold text-gray-900">Recent Applications</h2>
                  <p className="text-xs md:text-sm text-gray-600 mt-1">Your latest job submissions</p>
                </div>
                ...
                <div className="divide-y divide-gray-200">
                  {recentApplications.map((app) => (
                    <div key={app.id} className="px-4 md:px-6 py-3 md:py-4 hover:bg-gray-50 transition-colors cursor-pointer">
                      ...
                      <p className="text-xs text-gray-500 mt-2 md:mt-3">Applied {app.appliedDate}</p>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-sm font-bold text-gray-900">Top Skills</h3>
                </div>
